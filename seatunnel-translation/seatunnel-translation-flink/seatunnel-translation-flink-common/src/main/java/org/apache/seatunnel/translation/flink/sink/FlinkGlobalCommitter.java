...
public class FlinkGlobalCommitter<CommT, GlobalCommT>
    ...
    public List<GlobalCommT> filterRecoveredCommittables(List globalCommittables)
        ...
        if (recoverGlobalCommits && !globalCommittables.isEmpty()) {
            // Routed writers wait for this boundary before reopening their physical buckets.
            // Filtering without publishing the complete recovered batch would strand them.
