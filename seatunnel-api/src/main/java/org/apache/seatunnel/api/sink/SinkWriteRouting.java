...
/** Serializable writer ownership policy exposed through {@link SupportSinkWriteRouting}. */
public interface SinkWriteRouting extends Serializable {

    /** Returns the owning writer index in {@code [0, numberOfWriters)} for this record. */
